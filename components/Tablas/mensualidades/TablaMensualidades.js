...
const createData = (id, concepto, cantidad, inicio, fin) => {
  return { id, concepto, cantidad, inicio, fin };
};
...
const TablaMensualidades = ({ datos }) => {
  ...
  const rows = datosFiltrados.map(({ id, concepto, cantidad, inicio, fin }) => {
    return createData(id, concepto, cantidad, inicio, fin);
  });
